...
{
    /// <summary>
    /// Factory for creating remote API clients that invoke services through Dapr.
    /// </summary>
    public static class RemoteApiDaprClientFactory
    {
        /// <summary>
            ...
            Type iface)
        {
            ...
            var method = typeof(RemoteApiDaprClientFactory)
