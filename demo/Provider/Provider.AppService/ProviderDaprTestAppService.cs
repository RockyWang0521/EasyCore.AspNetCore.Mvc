...
{
    public class ProviderDaprTestAppService : EasyCoreAppService, IProviderDaprTestAppService
    {
        private readonly ITestEntityRepository _repository;

        public ProviderDaprTestAppService(ITestEntityRepository repository)
        {
