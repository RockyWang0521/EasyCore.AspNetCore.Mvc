...
{
    public class ProviderNacosTestAppService : EasyCoreAppService, IProviderNacosTestAppService
    {
        private readonly ITestEntityRepository _repository;

        public ProviderNacosTestAppService(ITestEntityRepository repository)
        {
